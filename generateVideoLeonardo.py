...
leonardo_api_key = ""
image_path = "./outputs/openAIImages/image0.png"
...
def generate_video_leonardo(image_path, prompt, video_path):
    print("Generating video with Leonardo... and done")
    ...
    #response = requests.post(
    #    "https://cloud.leonardo.ai/api/rest/v1/generate/video",
    #    headers=headers,
    #    json=video_gen_payload
    #)
    #response.raise_for_status()
    ...
    #        f"https://cloud.leonardo.ai/api/rest/v1/generate/video/{video_job_id}",
    #        headers=headers
    #    )
...
def main():
    generate_video_leonardo(image_path, prompt, video_path)
